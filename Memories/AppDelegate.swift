...
//  Memories
//
//  Created by Sugabelly on 10/16/18.
...
class AppDelegate: UIResponder, UIApplicationDelegate, UNUserNotificationCenterDelegate {
    ...
    func checkNotificationAuthorization() {
        ...
        center.getNotificationSettings { settings in
            guard settings.notificationCenterSetting != .enabled else { NSLog("Location notifications have been granted")
                return
            }
    ...
    func requestNotificationAuthorization() {
        ...
        center.requestAuthorization(options: [.alert, .sound]) { granted,
            ...
            let alertController = UIAlertController(title: "Authorization not granted",
