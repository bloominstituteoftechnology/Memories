...
class LocalNotificationHelper
{
    ...
    func scheuleDailyReminderNotification()
    {
        ...
        let notificationRequest = UNNotificationRequest(identifier: "dailyReminder", content: content, trigger: UNCalendarNotificationTrigger(dateMatching: dateComponent, repeats: true))
